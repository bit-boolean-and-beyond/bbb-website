    ...
    <div className="text-center px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          >
            <div className="relative w-full h-full rounded-lg shadow-lg transition-transform duration-500 group-hover:[transform:rotateY(180deg)] [transform-style:preserve-3d]">
              {/* Front side */}
